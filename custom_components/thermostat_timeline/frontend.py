...
async def _ensure_lovelace_resource(hass: HomeAssistant) -> None:
    """Add /local/... as a Lovelace resource if it isn't already present."""

    # ✅ Correct HA storage location for resources is "lovelace.resources".
    # Prefer HA's constants when available.
    try:
